...
namespace Mvc.Datatables.Processing
{
	public class DataTableProcessor : IDataTableProcessor
	{
		...
		public virtual PageResponse<TSource> Process<TSource>(IQueryable<TSource> query, FilterRequest request, Func<IQueryable<TSource>, IQueryable<TSource>> appendQuery = null)
		{
